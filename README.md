...
Test out the library using the latest version available on CDN using this Pen: https://codepen.io/jhabdas/pen/MpVeOE?editors=0012. Reference the [Use Cases](#use-cases) to get a feel for what it can do.
...
Or simply `curl -L -o fetch-inject.umd.js https://go.habd.as/fetch-inject` from the command line to download the latest minified UMD bundle.
