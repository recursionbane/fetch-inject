...
Try Fetch Inject on CodePen using the latest version available on CDN: <a target="playground" rel="noreferrer noopener" href="https://codepen.io/jhabdas/pen/MpVeOE?editors=0012">MpVeOE</a>.
