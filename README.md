...
Test out the library using the latest version available on CDN using this Pen: <a target="playground" rel="noreferrer noopener" href="https://codepen.io/jhabdas/pen/MpVeOE?editors=0012">https://codepen.io/jhabdas/pen/MpVeOE</a>. Reference the [Use Cases](#use-cases) to get a feel for what it can do.
